...
// BLE Service
static BLEUUID testDataServiceUUID(SERVICE_UUID);

// Humidity Characteristic
static BLEUUID testDataChararacteristicUUID(CHARACTERISTIC_UUID);
...
static BLERemoteCharacteristic* testDataCharacteristic;
